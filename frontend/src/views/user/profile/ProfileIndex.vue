...
import {ref, registerRuntimeCompiler, useTemplateRef} from "vue";
...
async function handleUpdata(){
  ...
  if (!photo) {
    ...
    try {
      const res = await api.post('/api/user/profile/updata',formData)
      const data = res.data
...
<template>
  <div class="ml-[33.33%]">
    <div class="card w-120 bg-base-200 shadow-sm mt-30">
      <div class="card-body">
